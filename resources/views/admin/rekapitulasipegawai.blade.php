            ...
            <div class="col-lg-6 col-md-8 col-sm-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-primary text-white">
                        <h6 class="font-weight-bold text-white my-0">LAPORAN ABSENSI PEGAWAI</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('rekapabsenpegawai.laporan') }}" target="_blank"  method="POST">
                            @csrf
                            <div class="form-group mb-4">
                                <label for="nik" class="font-weight-bold"><i class="fas fa-user mr-2"></i>Nama</label>
                                <select class="form-control custom-select" id="nik" name="nik" required>
